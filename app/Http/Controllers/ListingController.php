...
class ListingController extends Controller
{
    ...
    public function displayAll(){
        ...
        #$lowPrices = array_combine(range(500, 5000,500), range(500, 5000,500));
        #$midPrices = array_combine(range(5000, 15000,1000), range(5000, 15000,1000));
        #$midHighPrices = array_combine(range(15000, 30000,2500), range(15000, 30000,2500));
        #$highPrices = array_combine(range(30000, 50000,5000), range(30000, 50000,5000));
        #$vipPrices = array_combine(range(50000, 90000,10000), range(50000, 90000,10000));
        #$prices = array() + $lowPrices + $midPrices + $midHighPrices + $highPrices + $vipPrices;
