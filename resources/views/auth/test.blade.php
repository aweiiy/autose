                    ...
                    <div class="col-lg-10 col-md-10">
                        <div class="ad-listing-content">
                            ...
                            @if($item->price - $item->price < 0)
                                <span style="color: green;"><strong>{{ $item->price}} EUR</strong> </span><br><span>(Old price: {{ $item->price}} EUR)</span>
                            @elseif($item->price - $item->price > 0)
                                <span style="color: red;"><strong>{{ $item->price}} EUR</strong> </span><br><span>(Old price: {{ $item->price}} EUR)</span>
                            @else
                                <span><strong>{{ $item->price}} EUR</strong></span>
                            @endif
                        </div>
                    </div>
